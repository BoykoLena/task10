...
function showName(data) {
  ...
  function showInfo (e) {
    ...
    if (target.tagName === "LI") {
      ...
      birthYear.innerHTML = data.results[index].birth_year;
      gender.innerHTML = data.results[index].gender;
      films.innerHTML = " ";
      ...
      homeworld.innerHTML = data.results[index].homeworld;
      species.innerHTML = data.results[index].species;
      }
    }
}
